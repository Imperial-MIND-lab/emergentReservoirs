...
Alternatively, you can dowload the pre-computed results `outputs.zip` at https://drive.google.com/drive/folders/1ytO0QdTiJ_v9qIvta1WWMyUJMIZz0DLZ?usp=sharing, unzip and run `run_all.m` with `runAnalyses = false`. This will load the pre-computed results and reproduce all figures of our article.
