    ...
    methods (Access = private)
        ...
        function obj = setDefault(obj, property)
            ...
            if strcmp(obj.Ctype, 'random')
                % defaults for randomly-connected reservoirs
                if strcmpi(obj.Evolved, 'psi')
                    % psi-optimised GeneParams (for Lorenz)
                    defaults = struct('SR', 0.4, ...
                                      'Rho', 0.03, ...
                                      'Beta', 1e-8, ...
                                      'Sigma', 0.01, ...
                                      'InBias', 1.7);
                else
                    % loss-optimised GeneParams (for Lorenz; default)
                    defaults = struct('SR', 0.1, ...
                                      'Rho', 0.05, ...
                                      'Beta', 9e-8, ...
                                      'Sigma', 0.03, ...
                                      'InBias', 1.3);
            ...
            elseif strcmp(obj.Ctype, 'human')
                % defaults for human-connectome reservoirs
                if strcmpi(obj.Evolved, 'psi')
                    % psi-optimised GeneParams (for Lorenz)
                    defaults = struct('SR', 1.4, ...
                                      'Rho', 0.08, ...
                                      'Beta', 1e-8, ...
                                      'Sigma', 0.01, ...
                                      'InBias', 1.1);
